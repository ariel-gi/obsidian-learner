...
var LearningOSSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Test Connection").setDesc("Test if the Obsidian plugin can communicate with your Python backend.").addButton((btn) => btn.setButtonText("Test Connection").setCta().onClick(async () => {
      ...
      try {
        ...
        if (isConnected) {
          ...
          setTimeout(() => btn.setButtonText("Test Connection"), 2e3);
        } else {
...
var ChatSidebar = () => {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "learning-os-chat-container" }, /* @__PURE__ */ React.createElement("div", { className: "learning-os-chat-header" }, /* @__PURE__ */ React.createElement("h3", null, "Preferences Agent")), /* @__PURE__ */ React.createElement("div", { className: "learning-os-chat-history" }, messages.map((msg) => /* @__PURE__ */ React.createElement("div", { key: msg.id, className: `learning-os-chat-msg ${msg.role}` }, /* @__PURE__ */ React.createElement("strong", null, msg.role === "user" ? "You" : "OS"), /* @__PURE__ */ React.createElement("p", null, msg.content))), isLoading && /* @__PURE__ */ React.createElement("div", { className: "learning-os-chat-msg agent" }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("em", null, "Thinking...")))), /* @__PURE__ */ React.createElement("div", { className: "learning-os-chat-input-area" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      value: input,
  ...
  ), /* @__PURE__ */ React.createElement("button", { onClick: handleSend, disabled: isLoading }, "Send")));
};

// src/ui/SidebarView.tsx
var VIEW_TYPE_LEARNING_OS_CHAT = "learning-os-chat-view";
var ChatSidebarView = class extends import_obsidian3.ItemView {
  reactRoot;
  constructor(leaf) {
    super(leaf);
  }
  ...
  async onOpen() {
    ...
    ReactDOM.render(/* @__PURE__ */ React2.createElement(ChatSidebar, null), this.reactRoot);
  }
  async onClose() {
    if (this.reactRoot) {
...
// src/main.ts
var ROBOT_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bot"><path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2"/><path d="M20 14h2"/><path d="M15 13v2"/><path d="M9 13v2"/></svg>`;
var LearningOSPlugin = class extends import_obsidian4.Plugin {
  settings;
  async onload() {
    console.log("Loading Learning OS Plugin");
    await this.loadSettings();
    backendClient.updateConfig(this.settings);
    this.addSettingTab(new LearningOSSettingTab(this.app, this));
    this.registerView(
      VIEW_TYPE_LEARNING_OS_CHAT,
      (leaf) => new ChatSidebarView(leaf)
    );
    (0, import_obsidian4.addIcon)("learning-os-bot", ROBOT_ICON);
    this.addRibbonIcon("message-circle", "Open Learning OS Preferences", () => {
      this.activateView();
    });
    this.addCommand({
      id: "open-learning-os-chat",
      name: "Open Preferences Chat",
      callback: () => {
        this.activateView();
      }
    });
  ...
  onunload() {
    console.log("Unloading Learning OS Plugin");
  }
  async loadSettings() {
  ...
  async activateView() {
    ...
    let leaf = null;
    const leaves = workspace.getLeavesOfType(VIEW_TYPE_LEARNING_OS_CHAT);
    if (leaves.length > 0) {
      leaf = leaves[0];
    } else {
      ...
      if (rightLeaf) {
        leaf = rightLeaf;
        await leaf.setViewState({ type: VIEW_TYPE_LEARNING_OS_CHAT, active: true });
      }
    }
    if (leaf) {
